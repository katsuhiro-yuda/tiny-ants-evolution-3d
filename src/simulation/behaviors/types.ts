...
/**
 * 行動状態（仕様書 §7）。
 * Phase 1 で使うのは Explore / SeekFood / Eat / Rest の4つ。
 * Hunt / Flee / CarryFood / FollowPheromone / ReturnNest / Reproduce は後続Phaseで追加する。
 */
export type AntBehaviorState = 'Explore' | 'SeekFood' | 'Eat' | 'Rest';
